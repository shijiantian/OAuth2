...
replace INTO permission(type,url) VALUES(100,'/api/login');
replace INTO permission(type,url) VALUES(200,'/openapi/helloworld');
replace INTO role_permission(role_id,permission_type) VALUES(1,100),(2,200);